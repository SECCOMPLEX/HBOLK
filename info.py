...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>🪄 𝚀𝚞𝚎𝚛𝚢 ➠ {query}\n\n 𝚃𝚒𝚝𝚕𝚎 ➠ <i><a href={url}>{title}</a>\n ({year}) {release_date} • {runtime}min</i>\n\n  𝙶𝚎𝚗𝚛𝚎 ➠ <i>{genres}</i>\n 𝚁𝚊𝚝𝚒𝚗𝚐 ⭐️ ➠ <i>{rating}/10 ({votes})</i>\n 𝙻𝚊𝚗𝚐𝚞𝚊𝚐𝚎 ➠ <i>{languages}</i></b>\n\n  <b><a href="https://t.me/SECLK">®️ sᴇᴄ ʙᴏᴛs</a></b>")
